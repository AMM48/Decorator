...
public class LoggerDemo {
	...
	public static void main(String args[]) {
		// I changed this from FileLogger to DatabaseLogger for diversity
		BaseLogger logger = new DatabaseLogger();
		System.out.println(logger.getLabel() + ". Level: " + logger.getLevel());
		...
		System.out.println(logger2.getLabel() + ". Level: " + logger2.getLevel());
		...
		System.out.println(logger3.getLabel() + ". Level: " + logger3.getLevel());
	}
}